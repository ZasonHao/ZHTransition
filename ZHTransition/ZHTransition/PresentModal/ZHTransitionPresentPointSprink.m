//
//  ZHTransitionPresentPointSprink.m
//  ZHTransition
//
...
@interface ZHTransitionPresentPointSprink ()

@end

@implementation ZHTransitionPresentPointSprink
...
-(void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    if (touch.tapCount == 1) {
        [self pointSprinkViewControllerWithPresentModalAnimation:YES point:endPoint completion:^{
