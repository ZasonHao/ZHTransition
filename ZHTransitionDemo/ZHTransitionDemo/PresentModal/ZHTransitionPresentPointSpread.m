//
//  ZHTransitionPresentPointSpread.m
//  ZHTransition
//
...
#import "ZHTransitionPresentPointSprink.h"

#import "UIViewController+ZHTransition.h"
#import "UINavigationController+ZHTransition.h"

@interface ZHTransitionPresentPointSpread ()

@end

@implementation ZHTransitionPresentPointSpread
...
-(void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    if (touch.tapCount == 1) {
        ZHTransitionPresentPointSprink *vc = [[ZHTransitionPresentPointSprink alloc] init];
        [self pointSpreadViewControllerWithPresentModal:vc point:endPoint animation:YES completion:^{
            NSLog(@"transiton complete !");
        }];
    }
